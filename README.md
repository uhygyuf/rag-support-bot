...
|---|---|---|
| `tests/qa_suite.py` | **127 static + contract checks** (workflow shape 29, channels 23, reliability 17, UX 10, a11y 10, safety 9, integration 9, content 8, release 5, security 3, docs 3, quality 1) — no network, no writes | 127 / 127 PASS |
